      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            className="fixed bottom-[calc(72px+env(safe-area-inset-bottom,0px)+16px)] right-4 w-14 h-14 rounded-full bg-gradient-to-br from-gold to-[#b8964e] text-bg shadow-[0_4px_20px_rgba(200,169,125,0.3)] cursor-pointer z-[800] flex items-center justify-center active:scale-90 transition-transform"
          >
